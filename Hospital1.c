...
int main () {
    ...
    do {
      ...
      printf("14>Archiva los datos de los pacientes atendidos\n0>Salir.");
      ...
      switch (x) {
       ...
       case 3:  if (NroPacient>=1 || NroPrioridad>=1) { /// MUESTRA DE LOS PACIENTES ///
        ...
        case 5: if (NroPacient>=1) { /// RETIRO DE UN PACIENTE POR D.N.I///
                    int encontrado;
                    system("cls");
        ...
        break;
        case 8: if (NroPacient>=1) { /// MODIFICAR EDAD ///
                system("cls");
                do{
        ...
        break;
        case 9: if(NroAtendidos>=0) { /// MUESTRA PACIENTE ATENDIDOS Y NO ATENDIDOS ///
                system("cls");
                    do{
                ...
                if (NroAtendidos<0){
                        system("cls");
                        printf("No hay pacientes atendidos o que se retiraron para mostrar\n\nVOLVIENDO AL MENU PRINCIPAL...\n\n");
                }
        break;

        case 10:    system("cls"); /// ESCRITURA Y CARGA DE ARCHIVOS ///
                    printf("1>Escribir en un .txt los pacientes que no fueron atendidos\n2>Cargar de un .txt a la lista de ingreso un listado de pacientes\n");
                    do{
                        printf("\nIngrese la opcion a realizar: ");
                        scanf("%d", &x);
                        if (x<1 || x>2) {
                    ...
                    case 1: if(NroAtendidos>=0){
                                ...
                                fclose(fp);
                                    ...
                                    system("cls");
                                    printf("No hay pacientes atendidos para cargar al archivo\n\nVOLVIENDO AL MENU PRINCIPAL...\n\n");
                                }
                    break;
        ...
        case 13:if (NroPrioridad>=1) { /// MUESTRA CUANTOS PACIENTES HAY POR NIVEL DE URGENCIA ///
                    system("cls");
        ...
        case 14:if (NroAtendidos>=1){ /// ALMACENA LOS DATOS DE LOS PACIENTES ATENDIDOS ///
                    FILE *fp;
